 ...
 * Telegram 채널 메시지 포맷.
 *
 * Telegram Bot API sendMessage 의 "text" 필드.
 *   - plain text (parse_mode 없음) → HTML entity 이스케이프 불필요
 *   - TelegramSender 에서 4096자 초과 시 truncate 처리
 *
 * [확장 포인트]
 *   - parse_mode=HTML 을 사용하려면 buildHtml*(…) 로 변경하고
